...
interface MLSGroupView {
  ...
  exportSecret(
    label: MLSBytesOrUint8ArrayOrUTF8String,
    context: MLSBytesOrUint8Array,
    length: number
  ): Promise<MLSExporterOutput>;
...
interface OnErrorEventHandlerForNodes {
  ...
  addEventListener<K extends keyof OnErrorEventHandlerForNodesEventMap>(
    type: K,
    listener: (this: OnErrorEventHandlerForNodes, ev: OnErrorEventHandlerForNodesEventMap[K]) => any,
    options?: boolean | AddEventListenerOptions
  ): void;
  addEventListener(
    type: string,
...
interface OnErrorEventHandlerForWindow {
  ...
  addEventListener<K extends keyof OnErrorEventHandlerForWindowEventMap>(
    type: K,
    listener: (this: OnErrorEventHandlerForWindow, ev: OnErrorEventHandlerForWindowEventMap[K]) => any,
    options?: boolean | AddEventListenerOptions
  ): void;
  addEventListener(
    type: string,
...
interface SVGDiscardElement extends SVGAnimationElement {
  addEventListener<K extends keyof SVGAnimationElementEventMap>(
    type: K,
    listener: (this: SVGDiscardElement, ev: SVGAnimationElementEventMap[K]) => any,
    options?: boolean | AddEventListenerOptions
  ): void;
  addEventListener(
    type: string,
...
interface TestInterfaceIterableDoubleUnion {
  forEach(
    callbackfn: (value: string | number, key: string, parent: TestInterfaceIterableDoubleUnion) => void,
    thisArg?: any
  ): void;
}
...
interface TestInterfaceMaplikeObject {
  ...
  forEach(
    callbackfn: (value: TestInterfaceMaplike, key: string, parent: TestInterfaceMaplikeObject) => void,
    thisArg?: any
  ): void;
}
...
interface TouchEventHandlers {
  ...
  addEventListener<K extends keyof TouchEventHandlersEventMap>(
    type: K,
    listener: (this: TouchEventHandlers, ev: TouchEventHandlersEventMap[K]) => any,
    options?: boolean | AddEventListenerOptions
  ): void;
  addEventListener(
    type: string,
...
interface XRBoundedReferenceSpace extends XRReferenceSpace {
  ...
  addEventListener<K extends keyof XRReferenceSpaceEventMap>(
    type: K,
    listener: (this: XRBoundedReferenceSpace, ev: XRReferenceSpaceEventMap[K]) => any,
    options?: boolean | AddEventListenerOptions
  ): void;
  addEventListener(
    type: string,
...
declare namespace ChromeUtils {
  ...
  function shouldResistFingerprinting(
    target: JSRFPTarget,
    overriddenFingerprintingSettings: nsIRFPTargetSetIDL | null,
    isPBM?: boolean
  ): boolean;
...
declare namespace InspectorUtils {
  ...
  function replaceBlockRuleBodyTextInStylesheet(
...
interface GPUCommandEncoder {
  copyBufferToTexture(
    ...
    destination: GPUTexelCopyTextureInfo,
    copySize: Iterable<GPUIntegerCoordinate>
  ): void;
  copyTextureToBuffer(
